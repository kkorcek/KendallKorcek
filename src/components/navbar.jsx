...
const Navbar = () => {
    ...
    <nav className='navbar'>
        ...
        <ul className="navbar-icons">
            <li>
                <a href="https://www.linkedin.com/in/kendall-korcek" target="_blank" rel="noopener noreferrer">
                    <img src={linkedLight} data-hover={linkedDark} alt='LinkedIn' className='nav-icon hover-swap'></img>
                </a>
            </li>
            <li>
                <a href="https://github.com/kkorcek" target="_blank" rel="noopener noreferrer">
            ...
            <li>
                <a href="/Kendall-Korcek-Resume.pdf" download>
                    <img src={downloadLight} data-hover={downloadDark} alt='Download Resume' className='nav-icon hover-swap'></img>
